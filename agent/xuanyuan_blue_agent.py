...
class BlueRuleAgent(Agent):
    ...
    def step(self, sim_time,obs_blue, **kwargs):
        ...
        if self.agent_state == BlueAgentState.PATROL0 and curr_time >= PATROL_TIME1:
            ...
            self.agent_state = BlueAgentState.PATROL7
        elif self.agent_state == BlueAgentState.PATROL7 and curr_time >= PATROL_TIME7:
            cmd_list.extend(self._takeoff_areapatrol(2, 11, SHIP_POINT1, PATROL_PARAMS))
